    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"><a href="{{ route('admin.notification.email.index') }}">ایمیل
                    ها</a></li>
            <li class="breadcrumb-item font-size-12 active" aria-current="page">ویرایش اطلاعیه</li>
        </ol>
    </nav>
    <section class="row">
                        ...
                        <section class="row">
                            <section class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="title"
                                        value="{{ old('title', $email->title) }}" id="title">
                                </div>
                                @error('title')
                            ...
                            <section class="col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control form-control-sm" rows="6">{{ old('description', $email->description) }}</textarea>
                                </div>
                                @error('description')
                                    <span class="alert-danger" role="alert">
                                        <strong>

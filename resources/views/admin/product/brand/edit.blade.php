                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-4">
                                ...
                                @if ($brand->logo_path != null)
                                    <a class="mx-3" href="{{ asset($brand->logo_path) }}" target="_blank">
                                        <img src="{{ asset($brand->logo_path) }}" alt="{{ $brand->persian_name }}"
                                            width="50">
                                    </a>
                                @endif
                                @error('logo_path')
                            ...
                            <section class="col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control form-control-sm" rows="6">{{ old('description', $brand->description) }}</textarea>
                                </div>
                                @error('description')
                                    <span class="alert-danger" role="alert">
                                        <strong>

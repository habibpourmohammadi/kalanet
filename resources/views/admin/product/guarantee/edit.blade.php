    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.product.guarantee.update', $guarantee) }}" method="POST"
                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="original_name"
                                        value="{{ old('original_name', $guarantee->original_name) }}" id="original_name">
                                </div>
                                @error('original_name')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="persian_name"
                                        value="{{ old('persian_name', $guarantee->persian_name) }}" id="persian_name">
                                </div>
                                @error('persian_name')
                                    <span class="alert-danger" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control form-control-sm" rows="6">{{ old('description', $guarantee->description) }}</textarea>
                                </div>
                                @error('description')
                                    <span class="alert-danger" role="alert">
                                        <strong>

        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.product.guarantee.create') }}" class="btn btn-info btn-sm">ایجاد گارانتی</a>
                    <form action="{{ route('admin.product.guarantee.index') }}" method="GET" class="max-width-16-rem">
                        ...
                        <tbody>
                            @forelse ($guarantees as $guarantee)
                                <tr>
                                    ...
                                    <td>{{ Str::limit($guarantee->description, 80, '...') }}</td>
                                    <td class="width-16-rem text-left">
                                        <a href="{{ route('admin.product.guarantee.edit', $guarantee) }}"
                                            class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
                                            ویرایش</a>
                                        <form class="d-inline"
                                            action="{{ route('admin.product.guarantee.delete', $guarantee) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')

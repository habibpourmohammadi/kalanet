...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش ویژگی</li>
        </ol>
    </nav>
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.product.option.update', ['product' => $product, 'option' => $option]) }}"
                        method="POST" id="form">
                        @csrf
                        @method('PUT')
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="title"
                                        value="{{ old('title', $option->title) }}" id="title">
                                </div>
                                @error('title')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="option"
                                        value="{{ old('option', $option->option) }}" id="option">
                                </div>
                                @error('option')
                                    <span class="alert-danger" role="alert">
                                        <strong>

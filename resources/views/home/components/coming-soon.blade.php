...
@endsection
@section('content')
    <div class="px-52 py-32 bg-white">
        <div
            ...
            <h5 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white text-center pt-3">به زودی بخش {{ $name }} در دسترس عموم قرار می گیرد ...</h5>

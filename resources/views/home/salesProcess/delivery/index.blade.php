        ...
        <section class="container-xxl">
            <section class="row">
                <section class="col">
                    ...
                    <form action="{{ route('home.salesProcess.submitOrder') }}" method="POST">
                        @csrf
                            ...
                            <section class="col-md-9">
                                <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                    ...
                                    <section class="address-select">
                                        ...
                                        @empty
                                            <p class="text-center text-danger"><strong>شما هیچ آدرسی ثبت نکرده اید</strong>
                                            </p>
                                        @endforelse
                            ...
                            <section class="col-md-3">
                                <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                    ...
                                    <section class="">
                                        ...
                                        <button id="next-level" type="submit" class="btn btn-danger d-none w-100">ادامه
                                            فرآیند
                                            خرید</button>
                                    </section>
            ...
            <form action="{{ route('home.profile.myAddresses.store') }}" method="POST" class="address-add-wrapper"
                onsubmit="return myAddressForm()">
                @csrf
                            ...
                            <section class="modal-body">
                                <section class="row">
                                    ...
                                    <section class="col-12 col-md-6">
                                        ...
                                        <small class="text-danger"><strong id="mobileError"></strong></small>
                                    </section>
                                    <section class="col-12 mb-2">
                                        <label for="address" class="form-label mb-1">نشانی
                                            <strong class="text-danger">*</strong></label>
                                        <input type="text" class="form-control form-control-sm" id="address"
                                            placeholder="نشانی" name="address" value="{{ old('address') }}">
                                        <small class="text-danger"><strong id="addressError"></strong></small>
                                    </section>
                                    ...
                                    <section class="col-6 mb-2">
                                        <label for="postal_code" class="form-label mb-1">کد
                                            پستی
                                            <strong class="text-danger">*</strong></label>
                                        <input type="number" class="form-control form-control-sm" id="postal_code"
                                            placeholder="کد پستی" name="postal_code" value="{{ old('postal_code') }}">
                                        <small class="text-danger"><strong id="postalCodeError"></strong></small>
                                    </section>

                                    <section class="col-3 mb-2">
                                        <label for="no" class="form-label mb-1">پلاک</label>
                                        <input type="number" class="form-control form-control-sm" id="no"
                                            placeholder="پلاک" name="no" value="{{ old('no') }}">
                                        <small class="text-danger"><strong id="noError"></strong></small>
                                    </section>

                                    <section class="col-3 mb-2">
                                        <label for="unit" class="form-label mb-1">واحد</label>
                                        <input type="number" class="form-control form-control-sm" id="unit"
                                            placeholder="واحد" name="unit" value="{{ old('unit') }}">
                                        <small class="text-danger"><strong id="unitError"></strong></small>
                                    </section>
                                    ...
                                    <section class="col-12 mb-2">
                                        <section class="form-check">
                                            <input class="form-check-input" type="checkbox" value=""
                                                name="receiver" id="receiver" checked>
                                    ...
                                    <section class="row" id="recipient">
                                        <section class="col-6 mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="first_name"
                                                placeholder="نام گیرنده" name="recipient_first_name"
                                        ...
                                        <section class="col-6 mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="last_name"
                                                placeholder="نام خانوادگی گیرنده" name="recipient_last_name"
                                        ...
                                        <section class="col-6 mb-2">
                                            ...
                                            <input type="number" class="form-control form-control-sm"
                                                id="recipient_mobile" placeholder="شماره موبایل" name="recipient_mobile"
                                                value="{{ old('recipient_mobile') }}">
                                            <small class="text-danger"><strong id="recipientMobileError"></strong></small>
                                        </section>
                                    </section>
